...
Server::Server(int port, DedupCore* dedupObj){
	...
	//AF_INETΪipv4��ַ��SOCK_STREAMΪ���������׽��֣�IPPROTO_TCPΪTCP
	//����һ��int����ʾsocket
	if (hostSock_ == -1){
...
void* SocketHandler(void* lp){
	...
	while(true){
		...
		if (indicator == META){
			...
			//userΪ�����id metabufferΪ������������ count�����ݴ�С statuslist�Ƿ��ص�boolֵ�б� numofshare��statuslist������ datasize��Ӧ�͵�data��С
